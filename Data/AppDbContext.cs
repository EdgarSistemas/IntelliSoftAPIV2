...
namespace IntelliSoftAPI.Models
{
    public partial class AppDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        public virtual DbSet<TbCotizacionProducto> TbCotizacionProductos { get; set; }
        public virtual DbSet<TbCotizacionProductoDetalle> TbCotizacionProductoDetalles { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TbCatalogoUnidad>(entity =>
            {
                ...
                entity.Property(e => e.Nombre).HasMaxLength(25).IsUnicode(false).HasColumnName("nombre");
                entity.Property(e => e.Simbolo).HasMaxLength(5).IsUnicode(false).HasColumnName("simbolo");
            });
            ...
            modelBuilder.Entity<TbComentario>(entity =>
            {
                ...
                entity.Property(e => e.Mensaje).HasMaxLength(1000).IsUnicode(false).HasColumnName("mensaje");
            ...
            modelBuilder.Entity<TbCompra>(entity =>
            {
                ...
                entity.Property(e => e.ClaveCompra).HasMaxLength(65).IsUnicode(false).HasColumnName("clave_compra");
                entity.Property(e => e.Estatus).HasColumnName("estatus");
                entity.Property(e => e.FechaCompra).HasColumnType("datetime").HasColumnName("fecha_compra");
                entity.Property(e => e.Observacion).HasMaxLength(65).IsUnicode(false).HasColumnName("observacion");
            ...
            modelBuilder.Entity<TbCompraDetalle>(entity =>
            {
                ...
                entity.Property(e => e.PrecioUnitario).HasColumnType("decimal(18, 2)").HasColumnName("precio_unitario");
                entity.Property(e => e.Presentacion).HasMaxLength(50).IsUnicode(false).HasColumnName("presentacion");
            ...
            modelBuilder.Entity<TbCotizacion>(entity =>
            {
                ...
                entity.Property(e => e.ClaveCotizacion).HasMaxLength(65).HasColumnName("clave_cotizacion");
                entity.HasIndex(e => e.ClaveCotizacion).IsUnique();

                entity.Property(e => e.UsuarioId).HasColumnName("cliente_id");
                entity.Property(e => e.FechaSolicitud).HasColumnType("datetime").HasColumnName("fecha_solicitud");
                entity.Property(e => e.Estatus).HasColumnName("estatus").HasDefaultValue(1);
                entity.Property(e => e.DetalleCotizacion).HasColumnName("detalle_cotizacion").HasMaxLength(200).IsUnicode(false);
                ...
                // Header -> partidas
                entity.HasMany(c => c.CotizacionProductos)
                      .WithOne(cp => cp.Cotizacion)
                      .HasForeignKey(cp => cp.CotizacionId)
                      .OnDelete(DeleteBehavior.Cascade);
            });

            // ============================
            // COTIZACIÓN PRODUCTO (Partida)
            // ============================
            modelBuilder.Entity<TbCotizacionProducto>(entity =>
            {
                entity.HasKey(e => e.IdCotizacionProducto).HasName("PK_TB_CotizacionProducto");
                entity.ToTable("TB_CotizacionProducto", "operaciones");
                ...
                entity.Property(e => e.Hectareas).HasColumnName("hectareas").HasColumnType("decimal(18,4)");
                entity.Property(e => e.PorcentajeGanancia).HasColumnName("porcentaje_ganancia").HasColumnType("decimal(5,2)");
                entity.Property(e => e.PorcentajeRiesgo).HasColumnName("porcentaje_riesgo").HasColumnType("decimal(5,2)");
                entity.Property(e => e.AplicaRiesgo).HasColumnName("aplica_riesgo");

                entity.HasIndex(x => x.CotizacionId);
                entity.HasIndex(x => x.ProductoId);

                entity.HasOne(d => d.Producto)
                      .WithMany(p => p.TbCotizacionProductos)
                      .HasForeignKey(d => d.ProductoId)
                      .OnDelete(DeleteBehavior.ClientSetNull)
                      .HasConstraintName("FK_CotizacionProducto_Producto");

                // Partida -> Detalles
                entity.HasMany(cp => cp.Detalles)
                      .WithOne(d => d.CotizacionProducto)
                      .HasForeignKey(d => d.CotizacionProductoId)
                      .OnDelete(DeleteBehavior.Cascade);
            });

            // ============================
            // DETALLE (Insumos por Partida)
            // ============================
            modelBuilder.Entity<TbCotizacionProductoDetalle>(entity =>
            {
                entity.HasKey(e => e.IdCotizacionProductoDetalle).HasName("PK_TB_CotizacionProductoDetalle");
                entity.ToTable("TB_CotizacionProductoDetalle", "operaciones");

                entity.Property(e => e.IdCotizacionProductoDetalle).HasColumnName("id_cotizacion_producto_detalle");
                entity.Property(e => e.CotizacionProductoId).HasColumnName("cotizacion_producto_id");
                entity.Property(e => e.InsumoId).HasColumnName("insumo_id");
                entity.Property(e => e.Cantidad).HasColumnName("cantidad").HasColumnType("decimal(18,4)");
                entity.Property(e => e.PrecioPromedio).HasColumnName("precio_promedio").HasColumnType("decimal(18,2)");

                entity.HasIndex(x => x.CotizacionProductoId);
                entity.HasIndex(x => x.InsumoId);

                entity.HasOne(d => d.Insumo)
                      .WithMany(p => p.TbCotizacionProductoDetalles)
                      .HasForeignKey(d => d.InsumoId)
                      .OnDelete(DeleteBehavior.ClientSetNull)
            ...
            modelBuilder.Entity<TbInventarioInsumo>(entity =>
            {
                ...
                entity.Property(e => e.IdInventarioInsumo).HasColumnName("id_inventario_insumo").ValueGeneratedOnAdd();
                entity.Property(e => e.CompraId).HasColumnName("compra_id");
                entity.Property(e => e.Costo).HasColumnType("decimal(18, 2)").HasColumnName("costo");
                entity.Property(e => e.Debe).HasColumnType("decimal(18, 2)").HasColumnName("debe");
                entity.Property(e => e.Entrada).HasColumnName("entrada");
                entity.Property(e => e.Existencias).HasColumnName("existencias");
                entity.Property(e => e.Fecha).HasColumnType("datetime").HasColumnName("fecha");
                entity.Property(e => e.Haber).HasColumnType("decimal(18, 2)").HasColumnName("haber");
                entity.Property(e => e.InsumoId).HasColumnName("insumo_id");
                entity.Property(e => e.PedidoId).HasColumnName("pedido_id");
                entity.Property(e => e.Promedio).HasColumnType("decimal(18, 2)").HasColumnName("promedio");
                entity.Property(e => e.Saldo).HasColumnType("decimal(18, 2)").HasColumnName("saldo");
            ...
            modelBuilder.Entity<TbOpinion>(entity =>
            {
                ...
                entity.Property(e => e.UsuarioId).HasColumnName("cliente_id");
                entity.Property(e => e.Comentario).HasMaxLength(1000).IsUnicode(false).HasColumnName("comentario");
                entity.Property(e => e.Fecha).HasColumnType("datetime").HasColumnName("fecha");
                entity.Property(e => e.ProductoId).HasColumnName("producto_id");
                entity.Property(d => d.Estatus).HasDefaultValue(1).HasColumnName("estatus");
            ...
            modelBuilder.Entity<TbPedido>(entity =>
            {
                ...
                entity.Property(e => e.CotizacionId).HasColumnName("cotizacion_id");
                entity.Property(e => e.FechaPedido).HasColumnType("datetime").HasColumnName("fecha_pedido");
                entity.Property(e => e.Estatus).HasColumnName("estatus").HasDefaultValue(1);
            ...
            modelBuilder.Entity<TbProducto>(entity =>
            {
                ...
                entity.Property(e => e.HectareaBase).HasColumnType("decimal(10, 2)").HasColumnName("hectarea_base");
                entity.Property(e => e.Nombre).HasMaxLength(100).IsUnicode(false).HasColumnName("nombre");

                entity.HasMany(p => p.TbCotizacionProductos)
            ...
            modelBuilder.Entity<TbProveedor>(entity =>
            {
                ...
                entity.Property(e => e.Nombre).HasMaxLength(25).IsUnicode(false).HasColumnName("nombre");
                entity.Property(e => e.Contacto).HasMaxLength(50).IsUnicode(false).HasColumnName("contacto");
                entity.Property(e => e.Telefono).HasMaxLength(10).IsUnicode(false).HasColumnName("telefono");
                entity.Property(e => e.CorreoElectronico).HasMaxLength(50).IsUnicode(false).HasColumnName("correo_electronico");
                entity.Property(e => e.DescripcionServicio).HasMaxLength(100).IsUnicode(false).HasColumnName("descripcion_servicio");
                entity.Property(e => e.Estatus).HasDefaultValue(1).HasColumnName("estatus");
            });
            ...
            modelBuilder.Entity<TbProductoInsumo>(entity =>
            {
                ...
                entity.Property(e => e.Cantidad).HasColumnType("decimal(10, 2)").HasColumnName("cantidad");
                entity.Property(e => e.InsumoId).HasColumnName("insumo_id");
                entity.Property(e => e.ProductoId).HasColumnName("producto_id");
            ...
            modelBuilder.Entity<TbDocumento>(entity =>
            {
                ...
                entity.Property(e => e.NombreDocumento).HasMaxLength(500).IsUnicode(false).HasColumnName("nombre_columna");
                entity.Property(e => e.Url).HasColumnType("nvarchar(max)").HasColumnName("url");
            });
